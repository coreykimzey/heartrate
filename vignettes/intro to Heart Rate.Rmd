...
#Sample Dataset
I created a sample dataset. It has the first 21 days of data that I collected. This time I converted it into a tibble, so it would match the rest of the data. Here is just the first couple of rows:
```{r}
data("ckheartRate")
ckheartRate
```
