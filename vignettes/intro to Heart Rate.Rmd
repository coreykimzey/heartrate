...
1) I was able to connect my r package to github. I was able to push my package there. It took a little work but it works now. 
2) I did set-up git on my computer as well.
3) I synced my git with github.
4) I've been trying to improve my package. I'm a little stuck at the moment though. Do you have any suggestions on what to look at next? Right now, nothing seems to be close to significant. So I'm not sure what to do about that. I'm thinking of adding more functions or doing some time series analysis. Although, I don't know a lot about time series analysis.
5)Submitted a link.
